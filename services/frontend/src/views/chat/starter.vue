...
<template>
  <Layout>
                  ...
                  <BCol sm="8" cols="4">
                    <ul class="list-inline user-chat-nav text-end mb-0">
                      ...
                      <li class="list-inline-item d-none d-lg-inline-block m-0">
                        <BButton type="button" variant="ghost-secondary" class="btn-icon" @click="showOffcanvas = !showOffcanvas">
    ...
    <BOffcanvas placement="end" v-model="showOffcanvas" body-class="border-0 p-0 overflow-hidden" header-class="border-bottom">
      <div class="offcanvas-body profile-offcanvas p-0">
                ...
                <div class="user-chat-nav d-flex">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li><BLink class="dropdown-item" href="javascript:void(0);"><i class="ri-inbox-archive-line align-bottom text-muted me-2"></i>Archive</BLink></li>
                      <li><BLink class="dropdown-item" href="javascript:void(0);"><i class="ri-mic-off-line align-bottom text-muted me-2"></i>Muted</BLink></li>
                      <li><BLink class="dropdown-item" href="javascript:void(0);"><i class="ri-delete-bin-5-line align-bottom text-muted me-2"></i>Delete</BLink></li>
                    </ul>
                  </div>
                </div>
        ...
        <div class="p-3 text-center">
          ...
          <div class="mt-3">
            <h5 class="fs-16 mb-1"><BLink href="javascript:void(0);" class="link-primary username"> {{ username }}</BLink></h5>
          ...
          <div class="vstack gap-2">
            <div class="border rounded border-dashed p-2">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 overflow-hidden">
                  <h5 class="fs-13 mb-1"><BLink href="#" class="text-body text-truncate d-block">App pages.zip</BLink></h5>
                  ...
                  <div class="d-flex gap-1">
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><BLink class="dropdown-item" href="#"><i class="ri-share-line align-bottom me-2 text-muted"></i> Share</BLink></li>
                        <li><BLink class="dropdown-item" href="#"><i class="ri-bookmark-line align-bottom me-2 text-muted"></i> Bookmark</BLink></li>
                        <li><BLink class="dropdown-item" href="#"><i class="ri-delete-bin-line align-bottom me-2 text-muted"></i> Delete</BLink></li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div class="border rounded border-dashed p-2">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 overflow-hidden">
                  <h5 class="fs-13 mb-1"><BLink href="#" class="text-body text-truncate d-block">Velzon admin.ppt</BLink></h5>
            ...
            <div class="border rounded border-dashed p-2">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 overflow-hidden">
                  <h5 class="fs-13 mb-1"><BLink href="#" class="text-body text-truncate d-block">Images.zip</BLink></h5>
            ...
            <div class="border rounded border-dashed p-2">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 overflow-hidden">
                  <h5 class="fs-13 mb-1"><BLink href="#" class="text-body text-truncate d-block">bg-pattern.png</BLink></h5>
